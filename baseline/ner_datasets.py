...
sys.path.append('..')
import torch
sys.path.append("EJ_MatSciBERT/")
from normalize_text import normalize
# from EJ_MatSciBERT.normalize_text import normalize
...
def get_sofc_data(slotting, fold):
    ...
    # data_dir = 'EJ_MatSciBERT/ner/datasets/sofc-exp-corpus'
...
def get_matscholar_data():
    ...
    # data_dir = 'EJ_MatSciBERT/ner/datasets/NER_MATSCHOLAR/'
